...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">vendaverde documentation</a>
                </li>
                                ...
                                <a href="modules/AppModule.html" data-type="entity-link">AppModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-AppModule-f633cec72b7f28294933ba4bd9da94cd"' : 'data-target="#xs-components-links-module-AppModule-f633cec72b7f28294933ba4bd9da94cd"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-AppModule-f633cec72b7f28294933ba4bd9da94cd"' :
                                            'id="xs-components-links-module-AppModule-f633cec72b7f28294933ba4bd9da94cd"' }>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/CadastroProdutoCategoriaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">CadastroProdutoCategoriaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/DeleteProdutosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">DeleteProdutosComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PesquisaCategoriaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PesquisaCategoriaComponent</a>
                                            </li>
                                            <li class="link">
                                                <a href="components/PesquisaComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PesquisaComponent</a>
                                            </li>
                                            <li class="link">
                                            ...
                                            <li class="link">
                                                <a href="components/PutProdutosComponent.html"
                                                    data-type="entity-link" data-context="sub-entity" data-context-id="modules">PutProdutosComponent</a>
                                            </li>
                                            <li class="link">
